...
document.addEventListener("DOMContentLoaded", function () {
  ...
  $(document).on("click", ".js--anchor-link", function (e) {
    ...
    var elOffset = $($.attr(this, "href")).offset().top;
    var elHeight = $($.attr(this, "href")).outerHeight();
    var pageOffset;
...
var onCounterMinus = function onCounterMinus(id) {
  var val = getCounterVal(id);
...
var onCounterPlus = function onCounterPlus(id) {
  var val = getCounterVal(id);
  ++val;
  setCounterVal(id, val);
};

var getCounterVal = function getCounterVal(id) {
  return document.getElementById(id).value;
};

var setCounterVal = function setCounterVal(id, val) {
  var costItem = document.querySelector("[data-counter-cost-id=\"".concat(id, "\"]"));
  var costVal = +costItem.dataset.counterCost;
  document.getElementById(id).value = val;
  costItem.innerHTML = String(costVal * val);
};

var onToogleIngredients = function onToogleIngredients() {
